...
require(dplyr)
require(stringr)
# d=data.table(x1=1:5, x4=c(2,2,5,4,5), x3=c(3,2,NA,NA,5), x2=c(4,4,NA,4,5), x5=c(5,4,3,4,5)); d
# d[,":="(n.na=COUNT(d, "x", 1:5, value=NA),
#         n.2=COUNT(d, "x", 1:5, value=2),
#         sum=SUM(d, "x", 1:5),
#         mean1=MEAN(d, "x", 1:5),
#         mean2=MEAN(d, vars=c("x1", "x4")),
#         mean3=MEAN(d, varrange=c("x1", "x2")),
#         mean4=MEAN(d, varrange="x1:x2", rev="x2", likert=1:5),
#         sd=STD(d, "x", 1:5, rev=c(2, 5), likert=1:5),
